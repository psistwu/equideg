...
##  one line.
Subtitle := "GAP package for equivariant degree computation",
...
SourceRepository := rec(
    Type := "git",
    URL := Concatenation( "https://github.com/psistwu/", LowercaseString( ~.PackageName ) ),
),
...
# utilities.",
AbstractHTML := 
  "The <span class=\"pkgname\">EquiDeg</span> package provides \
   functions for equivariant degree computation.",
...
PackageDoc := rec(
  ...
  LongTitle := "EquiDeg/Equiviriant Degree Computation",
),
