#############################################################################
##
#W  ElementaryCLG.gi	GAP Package `EquiDeg'	    Haopin Wu
##
...
##
  InstallGlobalFunction( ElementaryCLGId,
    function( id... )
      if IsList( id[ 1 ] ) then
        id := id[ 1 ];
      fi;
...
##
  InstallMethod( \=,
    ...
    [ IsCompactLieGroup and HasIdElementaryCLG,
      IsCompactLieGroup and HasIdElementaryCLG ],
    function( G, H )
      return IdElementaryCLG( G ) = IdElementaryCLG( H );
    end
  );
...
##
  InstallMethod( \in,
    ...
    [ IsObject, IsCompactLieGroup and HasIdElementaryCLG ],
    function( obj, G )
      if not ( IdElementaryCLG( G )[ 1 ] = 1 ) then
        TryNextMethod( );
      fi;
...
##
  InstallMethod( \in,
    ...
    [ IsObject, IsCompactLieGroup and HasIdElementaryCLG ],
    function( obj, G )
      if not ( IdElementaryCLG( G )[ 1 ] = 2 ) then
        TryNextMethod( );
      fi;
...
##
  InstallMethod( IsSubset,
    ...
    function( G, U )
      ...
      type_G := IdElementaryCLG( G )[ 1 ];
      type_U := IdElementaryCLG( U )[ 1 ];
      d_G := IdElementaryCLG( G )[ 2 ];
      d_U := IdElementaryCLG( U )[ 2 ];
...
##
  InstallMethod( ConjugacyClassesSubgroups,
    ...
    function( G )
      ...
      if not ( IdElementaryCLG( G ) = [ 2, 2 ] ) then
        TryNextMethod( );
      fi;
  ...
  InstallMethod( Refolded,
    ...
    function( chi, l )
      ...
      if not HasIdElementaryCLG( G1 ) or
         not ( IdElementaryCLG( G1 ) = [ 1, 2 ] ) then
        TryNextMethod( );
      fi;
...
##
  ...
  InstallMethod( OrbitTypes,
    ...
    function( chi )
      ...
      G := UnderlyingGroup( chi );
      if not HasIdElementaryCLG( G ) and
          not ( IdElementaryCLG( G ) = [ 2, 2 ] ) then
        TryNextMethod( );
      fi;
